...
class PodcastGenerator {
    ...
    buildSystemPrompt() {
        return [
            ...
            '',
            'Your mission:',
            'Ask curious questions. A curious question is the opposite of a loaded question. Curious questions invite the guest to share in an open-ended manner, are implicitly framed as one of many options the guest may choose, and sometimes guide the discussion towards deeper understanding rather than surface level content if appropriate.',
            '',
            ...
            '- If humans are acknowledging, thinking aloud, talking amongst themselves, or developing a thought, set shouldRespond=false.',
