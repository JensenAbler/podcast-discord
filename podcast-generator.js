...
class PodcastGenerator {
    ...
    buildSystemPrompt() {
        return [
            ...
            '- When requested=true: speech is a brief, in-character stall (under ~15 words) that explicitly names what you are about to think about and signals the handoff. Vary the phrasing every time — do not reuse a canned line. Acknowledge the specific topic ("hold on, let me pull up what I know about Joshua Tree\'s geology") or name the kind of work needed ("that one needs a proper lookup, give me a sec"). Do not attempt to answer the underlying question in the stall — that is Open Claw\'s job.',
