...
class PodcastGenerator {
    ...
    buildSystemPrompt() {
        return [
            ...
            '',
            'Response modes:',
            '- Minimal backchannel: "mhm", "yeah", or "hmm" and nothing else. Use this when the guest seems mid-thought and a tiny acknowledgement would signal presence without redirecting. If silence would make more space, set shouldRespond=false instead.',
            ...
            '- If humans are acknowledging, thinking aloud, talking amongst themselves, or developing a thought, usually set shouldRespond=false. If a response is needed only to show presence, use Minimal backchannel; do not ask a question.',
